...
function SignInForm() {
  const toggleView = (view: "signin" | "signup"): void => {
    ...
    if (!signupCard || !forgotPasswordContainer || !subscribeContainer) return;

    const imgElement = signupCard.querySelector("img");
    if (!imgElement) return;

    if (view === "signin") {
      imgElement.src = SignInImage;
      forgotPasswordContainer.classList.remove("d-none");
      subscribeContainer.classList.add("d-none");
    } else if (view === "signup") {
      imgElement.src = SignUpImage;
            ...
            <div className="card-body formbg">
              ...
              <form id="signupForm">
                ...
                <div className="mb-3" id="forgotPasswordContainer">
                  <a href="#" id="forgotPasswordLink" className="lasthover">
                ...
                <div className="mb-3 d-flex justify-content-between">
                  <button
                    type="button"
                    className="btn btn-secondary signinbutton"
