...
import type { Product } from "../../services/products_services";
...
const StoreProducts = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      setProductsData(response.data as Product[]);
  ...
  const toggleFavorite = async (productId: number) => {
    try {
      ...
      const response = await axios.post(
        `${API_URL}/products/${productId}/toggle_favorite/`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    try {
      if (category === "All") {
        ...
        const response = await axios.get(
          `${API_URL}/categories/${category}/products/`
        );
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="input-group mb-1">
                ...
                />
                <button
                  className="btn btn-success storebutton"
                  type="button"
                  id="searchButton"
                >
                  {" "}
          ...
          <div className="row">
            <div className="col-md-2 mb-3">
              <ul className="list-group" id="js-categories-list">
                ...
                <li
                  className="list-group-item"
                  onClick={() => filterProducts("Blu-ray")}
                >
                  Blu-ray
                </li>
                <li
                ...
                <li
                  className="list-group-item"
                  onClick={() => filterProducts("Figures")}
                >
                  Figures
                </li>
                <li
                  className="list-group-item"
                  onClick={() => filterProducts("Manga")}
                >
                  Manga
                </li>
              </ul>
            ...
            <div className="modal-body d-flex flex-column align-items-center justify-content-center">
              {selectedProduct && (
                <>
                  ...
                  <p>
                    {" "}
                    <FaCheckCircle /> {/* Icono de confirmación */}
                    {selectedProduct.name}
                  </p>{" "}
                  {/* Nombre del producto */}
                  <button
                    onClick={handleGoToCart}
                    className="btn btn-secondary gotocartbutton"
                    data-bs-dismiss="modal"
                  >
                    Go to Cart
                  </button>
